...
namespace SkyFilter.Azure.Tests.WhereGreaterThan
{
    ...
    internal class When_I_generate_a_filter_where_a_int_partition_key_is_greater_than_10
    {
        private static string _expectedFilter;
        private static IAzureTableFilter _result;

        private Establish ctx = () => _expectedFilter = "PartitionKey gt 10";

        private Because of = () => _result = GenerateTableFilter.WhereGreaterThan("PartitionKey", 10);
