...
namespace SkyFilter.Azure.Tests.WhereLessThan
{
    ...
    internal class When_I_generate_a_filter_where_a_guid_partition_key_is_less_than_the_empty_guid
    {
        private static string _expectedFilter;
        private static IAzureTableFilter _result;

        private Establish ctx = () => _expectedFilter = "PartitionKey lt guid'00000000-0000-0000-0000-000000000000'";

        private Because of = () => _result = GenerateTableFilter.WhereLessThan("PartitionKey", Guid.Empty);
