...
namespace SkyFilter.Azure.Tests.WhereLessThan
{
    ...
    internal class When_I_generate_a_filter_where_a_double_partition_key_is_less_than_10_point_5
    {
        private static string _expectedFilter;
        private static IAzureTableFilter _result;

        private Establish ctx = () => _expectedFilter = "PartitionKey lt 10.5";

        private Because of = () => _result = GenerateTableFilter.WhereLessThan("PartitionKey", 10.5);
