...
{
    [Subject(typeof (GenerateAzureTableFilter), "WhereNotEquals")]
        ...
        private Establish ctx = () =>
            {
                ...
                _expectedFilter = "RowKey ne guid'00000000-0000-0000-0000-000000000000'";
            };

        private Because of = () => _result = _sut.WhereNotEqual("RowKey", Guid.Empty);
