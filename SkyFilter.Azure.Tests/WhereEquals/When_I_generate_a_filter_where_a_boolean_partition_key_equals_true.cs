...
namespace SkyFilter.Azure.Tests.WhereEquals
{
    ...
    internal class When_I_generate_a_filter_where_a_boolean_partition_key_equals_true
    {
        private static string _expectedFilter;
        private static IAzureTableFilter _result;

        private Establish ctx = () => _expectedFilter = "PartitionKey eq true";

        private Because of = () => _result = GenerateTableFilter.WhereEqual("PartitionKey", true);
