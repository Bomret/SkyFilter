...
namespace SkyFilter.Azure.Tests.WhereGreaterThanOrEqual
{
    ...
    internal class When_I_generate_a_filter_where_a_string_partition_key_is_greater_than_or_equal_to_hello
    {
        private static string _expectedFilter;
        private static IAzureTableFilter _result;

        private Establish ctx = () => _expectedFilter = "PartitionKey ge 'hello'";

        private Because of = () => _result = GenerateTableFilter.WhereGreaterThanOrEqual("PartitionKey", "hello");
