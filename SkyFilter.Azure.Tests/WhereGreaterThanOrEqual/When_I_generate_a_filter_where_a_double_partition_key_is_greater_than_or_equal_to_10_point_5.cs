...
namespace SkyFilter.Azure.Tests.WhereGreaterThanOrEqual
{
    ...
    internal class When_I_generate_a_filter_where_a_double_partition_key_is_greater_than_or_equal_to_10_point_5
    {
        private static string _expectedFilter;
        private static IAzureTableFilter _result;

        private Establish ctx = () => _expectedFilter = "PartitionKey ge 10.5";

        private Because of = () => _result = GenerateTableFilter.WhereGreaterThanOrEqual("PartitionKey", 10.5);
