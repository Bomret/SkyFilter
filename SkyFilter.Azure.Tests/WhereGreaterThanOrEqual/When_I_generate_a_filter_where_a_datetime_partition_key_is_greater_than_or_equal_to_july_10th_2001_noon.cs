...
namespace SkyFilter.Azure.Tests.WhereGreaterThanOrEqual
{
    ...
    internal class When_I_generate_a_filter_where_a_datetime_partition_key_is_greater_than_or_equal_to_july_10th_2001_noon
    {
        private static string _expectedFilter;
        private static IAzureTableFilter _result;

        private Establish ctx = () => _expectedFilter = "PartitionKey ge datetime'2001-07-10T12:00:00.0000000Z'";

        private Because of = () => _result = GenerateTableFilter.WhereGreaterThanOrEqual("PartitionKey", new DateTimeOffset(2001, 7, 10, 12, 0, 0, TimeSpan.Zero));
