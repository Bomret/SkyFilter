...
namespace SkyFilter.Azure.Tests.WhereNotEqual
{
    ...
    internal class When_I_generate_a_filter_where_a_double_partition_key_not_equals_10_point_5
    {
        private static string _expectedFilter;
        private static IAzureTableFilter _result;

        private Establish ctx = () => _expectedFilter = "PartitionKey ne 10.5";

        private Because of = () => _result = GenerateTableFilter.WhereNotEqual("PartitionKey", 10.5);
