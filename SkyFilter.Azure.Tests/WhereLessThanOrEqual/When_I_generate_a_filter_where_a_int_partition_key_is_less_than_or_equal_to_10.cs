...
namespace SkyFilter.Azure.Tests.WhereLessThanOrEqual
{
    ...
    internal class When_I_generate_a_filter_where_a_int_partition_key_is_less_than_or_equal_to_10
    {
        private static string _expectedFilter;
        private static IAzureTableFilter _result;

        private Establish ctx = () => _expectedFilter = "PartitionKey le 10";

        private Because of = () => _result = GenerateTableFilter.WhereLessThanOrEqual("PartitionKey", 10);
